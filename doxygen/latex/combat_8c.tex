...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{combat_8c_af1837e95d769962576e597337aa9073f}{afficher\+Round}} (SDL\+\_\+\+Renderer $\ast$renderer, int largeurF, int hauteurF, int round, personnage $\ast$Joueur1, personnage $\ast$Joueur2, SDL\+\_\+\+Texture $\ast$BG)
...
void \mbox{\hyperlink{combat_8c_abd867605ae9bc8f0edc515904b9de730}{init\+Perso}} (SDL\+\_\+\+Renderer $\ast$renderer, personnage $\ast$J1, personnage $\ast$J2)
...
int \mbox{\hyperlink{combat_8c_aeb2e7cbc23b26c8c484a4963219e2785}{round\+Start}} (SDL\+\_\+\+Renderer $\ast$renderer, Uint8 $\ast$keyboard\+State, personnage $\ast$Joueur1, personnage $\ast$Joueur2, int largeurF, int hauteurF, int wait\+For\+Frame, Mix\+\_\+\+Chunk $\ast$hit, Mix\+\_\+\+Chunk $\ast$dmg, Mix\+\_\+\+Chunk $\ast$stun, int $\ast$liste\+\_\+touches, int round, SDL\+\_\+\+Texture $\ast$stun\+Texture, rectangle $\ast$stun\+Rect, SDL\+\_\+\+Rect $\ast$$\ast$stun\+Texture\+Rect)
\begin{DoxyCompactList}\small\item\em Gère le déroulement d\textquotesingle{}un round de combat. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{combat_8c_a713655dcda992202a3bea06422419e6a}{combat\+Start}} (SDL\+\_\+\+Renderer $\ast$renderer, Uint8 $\ast$keyboard\+State, personnage $\ast$Joueur1, personnage $\ast$Joueur2, int largeurF, int hauteurF, int son, int $\ast$liste\+\_\+touches)
...
{\footnotesize\ttfamily void afficher\+Round (\begin{DoxyParamCaption}\item[{SDL\+\_\+\+Renderer $\ast$}]{renderer,  }\item[{int}]{largeurF,  }\item[{int}]{hauteurF,  }\item[{int}]{round,  }\item[{personnage $\ast$}]{Joueur1,  }\item[{personnage $\ast$}]{Joueur2,  }\item[{SDL\+\_\+\+Texture $\ast$}]{BG }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily void combat\+Start (\begin{DoxyParamCaption}\item[{SDL\+\_\+\+Renderer $\ast$}]{renderer,  }\item[{Uint8 $\ast$}]{keyboard\+State,  }\item[{personnage $\ast$}]{Joueur1,  }\item[{personnage $\ast$}]{Joueur2,  }\item[{int}]{largeurF,  }\item[{int}]{hauteurF,  }\item[{int}]{son,  }\item[{int $\ast$}]{liste\+\_\+touches }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily void init\+Perso (\begin{DoxyParamCaption}\item[{SDL\+\_\+\+Renderer $\ast$}]{renderer,  }\item[{personnage $\ast$}]{J1,  }\item[{personnage $\ast$}]{J2 }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily int round\+Start (\begin{DoxyParamCaption}\item[{SDL\+\_\+\+Renderer $\ast$}]{renderer,  }\item[{Uint8 $\ast$}]{keyboard\+State,  }\item[{personnage $\ast$}]{Joueur1,  }\item[{personnage $\ast$}]{Joueur2,  }\item[{int}]{largeurF,  }\item[{int}]{hauteurF,  }\item[{int}]{wait\+For\+Frame,  }\item[{Mix\+\_\+\+Chunk $\ast$}]{hit,  }\item[{Mix\+\_\+\+Chunk $\ast$}]{dmg,  }\item[{Mix\+\_\+\+Chunk $\ast$}]{stun,  }\item[{int $\ast$}]{liste\+\_\+touches,  }\item[{int}]{round,  }\item[{SDL\+\_\+\+Texture $\ast$}]{stun\+Texture,  }\item[{rectangle $\ast$}]{stun\+Rect,  }\item[{SDL\+\_\+\+Rect $\ast$$\ast$}]{stun\+Texture\+Rect }\end{DoxyParamCaption})}
