if(scene == CHAMP_SELECT) {
            // RYU
                ...
                // Appuie et relache sur le bouton
                    ...
                    if(J2Pick) {
                        Joueur2 = creerPerso(renderer, RYU, &largeurF, &hauteurF, 10/7.0, 10.0, 5.0, 9/7.0, &listeRectangle);
                        ...
                        Joueur1 = creerPerso(renderer, RYU, &largeurF, &hauteurF, 10.0, 10.0, 5.0, 9/7.0, &listeRectangle);
